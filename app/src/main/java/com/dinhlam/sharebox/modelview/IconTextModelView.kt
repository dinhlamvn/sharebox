...
data class IconTextModelView(
    ...
    override fun createViewHolder(
        ...
        return object : BaseListAdapter.BaseViewHolder<IconTextModelView, ModelViewIconTextBinding>(
            ModelViewIconTextBinding.inflate(inflater, container, false)
        ) {

            override fun onBind(model: IconTextModelView, position: Int) {
