...
data class ListImageListModel(
    ...
    private class ShareListImageViewHolder(
    ...
    ) : BaseListAdapter.BaseViewHolder<ListImageListModel, ModelViewListImageBinding>(
        binding
    ) {
        ...
        override fun onBind(model: ListImageListModel, position: Int) {
