...
data class ResourceImageModelView(
...
) : BaseListAdapter.BaseModelView("image_model_view_$drawableRes") {

    override fun createViewHolder(
        inflater: LayoutInflater, container: ViewGroup
    ): BaseListAdapter.BaseViewHolder<*, *> {
        return object :
            BaseListAdapter.BaseViewHolder<ResourceImageModelView, ModelViewImageBinding>(
                ModelViewImageBinding.inflate(inflater, container, false)
            ) {

            override fun onBind(model: ResourceImageModelView, position: Int) {
