...
data class TrendingShareQuoteListModel(
    val shareId: String,
    val quote: String?,
    val shareDate: Long,
    ...
    private class TrendingShareWebLinkViewHolder(
    ...
    ) : BaseListAdapter.BaseViewHolder<TrendingShareQuoteListModel, ModelViewTrendingShareQuoteBinding>(
        binding
    ) {
        ...
        override fun onBind(model: TrendingShareQuoteListModel, position: Int) {
