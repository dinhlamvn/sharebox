...
data class ListUrlListModel(
    ...
    private class ShareListUrlWebHolder(
    ...
    ) : BaseListAdapter.BaseViewHolder<ListUrlListModel, ModelViewListUrlBinding>(
        binding
    ) {
        ...
        override fun onBind(model: ListUrlListModel, position: Int) {
