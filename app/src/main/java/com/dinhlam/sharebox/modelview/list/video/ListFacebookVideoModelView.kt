...
import com.dinhlam.sharebox.databinding.ModelViewListVideoFacebookBinding
...
data class ListFacebookVideoModelView(
    val id: String,
    val videoId: String,
    ...
    override fun createViewHolder(
        ...
        return ListFacebookVideoViewHolder(
            ModelViewListVideoFacebookBinding.inflate(
    ...
    private class ListFacebookVideoViewHolder(binding: ModelViewListVideoFacebookBinding) :
        BaseListAdapter.BaseViewHolder<ListFacebookVideoModelView, ModelViewListVideoFacebookBinding>(
            binding
        ) {
        ...
        override fun onBind(model: ListFacebookVideoModelView, position: Int) {
