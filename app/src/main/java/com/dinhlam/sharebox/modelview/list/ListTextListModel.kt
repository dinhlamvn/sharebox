...
data class ListTextListModel(
    ...
    class ShareListTextViewHolder(
    ...
    ) : BaseListAdapter.BaseViewHolder<ListTextListModel, ModelViewListTextBinding>(
        binding
    ) {
        ...
        override fun onBind(model: ListTextListModel, position: Int) {
