...
data class MainActionModelView(
...
) : BaseListAdapter.BaseModelView("main_action") {

    override fun createViewHolder(
        inflater: LayoutInflater,
        container: ViewGroup
    ): BaseListAdapter.BaseViewHolder<*, *> {
        return object : BaseListAdapter.BaseViewHolder<MainActionModelView, ViewMainActionBinding>(
            ...
            override fun onBind(model: MainActionModelView, position: Int) {
