...
data class TrendingShareImagesListModel(
    val shareId: String,
    val uri: Uri?,
    val numberImage: Int,
    val shareDate: Long,
    ...
    private class TrendingShareWebLinkViewHolder(
    ...
    ) : BaseListAdapter.BaseViewHolder<TrendingShareImagesListModel, ModelViewTrendingShareImagesBinding>(
        binding
    ) {
        ...
        override fun onBind(model: TrendingShareImagesListModel, position: Int) {
