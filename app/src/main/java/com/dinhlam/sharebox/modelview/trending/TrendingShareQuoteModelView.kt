...
import com.dinhlam.sharebox.databinding.ModelViewTrendingShareQuoteBinding
...
data class TrendingShareQuoteModelView(
    val shareId: String,
    val quote: String?,
    val shareDate: Long,
    ...
    override fun createViewHolder(
        ...
        return TrendingShareWebLinkViewHolder(
            ModelViewTrendingShareQuoteBinding.inflate(
    ...
    private class TrendingShareWebLinkViewHolder(
        binding: ModelViewTrendingShareQuoteBinding
    ) : BaseListAdapter.BaseViewHolder<TrendingShareQuoteModelView, ModelViewTrendingShareQuoteBinding>(
        binding
    ) {
        ...
        override fun onBind(model: TrendingShareQuoteModelView, position: Int) {
            ...
            binding.textShare.text = model.quote
