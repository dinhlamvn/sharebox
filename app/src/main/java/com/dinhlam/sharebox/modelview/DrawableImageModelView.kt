...
data class DrawableImageModelView(
...
) : BaseListAdapter.BaseModelView("image_model_view_$drawable") {

    override fun createViewHolder(
        inflater: LayoutInflater, container: ViewGroup
    ): BaseListAdapter.BaseViewHolder<*, *> {
        return object :
            BaseListAdapter.BaseViewHolder<DrawableImageModelView, ModelViewImageBinding>(
                ModelViewImageBinding.inflate(inflater, container, false)
            ) {

            override fun onBind(model: DrawableImageModelView, position: Int) {
